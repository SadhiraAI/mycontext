...
class TrendIdentifier(Pattern):
    ...
    GENERIC_PROMPT = (
        "You are an expert trend analyst. Perform systematic trend detection "
        ...
        "(1) Identify primary trends - detect the overall direction (upward, "
        "downward, stable, volatile) and characterize the pattern shape. "
        "(2) Quantify trends - measure rate of change, acceleration, and "
        "volatility with concrete metrics and percentages. "
        "(3) Distinguish signal from noise - separate meaningful patterns from "
        "random fluctuations and identify cyclical or seasonal components. "
        "(4) Analyze drivers - determine what causal factors and external "
        "forces are driving the observed trends. "
        "(5) Assess sustainability - evaluate whether trends will continue, "
        "plateau, or reverse based on underlying structural conditions. "
