...
class ContentOutliner(Pattern):
    ...
    GENERIC_PROMPT = (
        "You are an expert content strategist and technical writer. Create a "
        "comprehensive, structured outline for the following content.\n\n"
        "Topic: {topic}\n"
        ...
        "Purpose: {purpose}\n"
        "{context_section}\n\n"
        "Apply audience-first content structuring methodology:\n"
        "(1) Define content strategy — identify the primary goal, audience "
        "knowledge level, desired post-reading action, and core takeaway. "
        "(2) Create 3-5 compelling title options with rationale for each. "
        "(3) Design the opening hook — choose a strategy (question, story, "
        "statistic, or problem) and draft an attention-grabbing opener. "
        "(4) Build hierarchical sections (H1/H2/H3) — each section needs a "
        "clear purpose, 2-3 key points, supporting content elements, and a "
        "transition to the next section. "
        "(5) Plan supporting elements — visual assets, code examples, links, "
        "and a word-count breakdown by section. "
